...
namespace GdiTest
{
    ...
    public class Teapot 
    {
        ...
        public void Draw(int grid, double scale, uint type)
        {
            ...
            GL.PushAttrib(GL.ENABLE_BIT | GL.EVAL_BIT);
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                GL.Map2(GL.MAP2_TEXTURE_COORD_2, 0.0f, 1.0f, 2, 2, 0.0f, 1.0f, 4, 2,
                  tex.Flatten());
                GL.Map2(GL.MAP2_VERTEX_3, 0, 1, 3, 4, 0, 1, 12, 4,
                  p.Flatten());
