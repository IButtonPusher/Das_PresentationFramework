...
public class AppliedRuleBuilder : IAppliedStyleBuilder
{
                                     ...
                                     IVisualBootstrapper visualBootstrapper)
   {
      ...
      var appliedStyle = BuildAppliedStyle(useStyle, visual, 
         visualLineage, visualBootstrapper);
   ...
   public void ApplyVisualStyle(IVisualElement visual,
                                IStyleSheet styleSheet,
                                IVisualBootstrapper visualBootstrapper)
   {
      var visualLineage = new VisualLineage();
      var appliedStyle = BuildAppliedStyle(styleSheet, visual, 
         visualLineage, visualBootstrapper);
