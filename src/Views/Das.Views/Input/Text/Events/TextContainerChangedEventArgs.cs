...
namespace Das.Views.Input.Text.Events
{
    ...
    /// </summary>
    public class TextContainerChangedEventArgs : EventArgs
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        public TextContainerChangedEventArgs()
        {
            _changes = new SortedList<Int32, TextChange>();
        }
        ...
        public void SetLocalPropertyValueChanged()
        {
            _hasLocalPropertyValueChange = true;
        }

        // Adds a new change to the Delta list.
        public void AddChange(PrecursorTextChangeType textChange,
                              Int32 offset,
                              Int32 length,
                              Boolean collectTextChanges)
        {
        ...
        public void MergePropertyChanges()
        {
        ...
        /// </summary>
        /// <value></value>
        public Boolean HasContentAddedOrRemoved => _hasContentAddedOrRemoved;
        ...
        /// </remarks>
        public Boolean HasLocalPropertyValueChange => _hasLocalPropertyValueChange;

        /// <summary>
        ///     List of TextChanges representing the aggregate changes made to the container.
        /// </summary>
        public SortedList<Int32, TextChange> Changes => _changes;
        ...
        //        
        private void AddChangeToList(PrecursorTextChangeType textChange,
                                     Int32 offset,
                                     Int32 length)
        {
            var offsetDelta = 0; // Value by which to adjust other offsets in list
            Int32 curIndex; // loop counter
            ...
            //
            var keyIndex = Changes.IndexOfKey(offset);
            if (keyIndex != -1)
            {
            ...
            else if (textChange == PrecursorTextChangeType.ContentRemoved ||
                     textChange == PrecursorTextChangeType.ElementExtracted)
            {
            ...
            if (offsetDelta != 0)
            {
                var newChanges = new SortedList<Int32, TextChange>(Changes.Count);
        ...
        private Boolean MergeTextChangeLeft(TextChange oldChange,
                                            TextChange newChange,
                                            Boolean isDeletion,
                                            Int32 length)
        {
            ...
            if (oldChange.Offset + oldChange.AddedLength >= newChange.Offset)
            {
                ...
                if (isDeletion)
                {
                    ...
                    var cancelledCount = Math.Min(overlap, newChange.RemovedLength);
        ...
        private void MergeTextChangeRight(TextChange oldChange,
                                          TextChange newChange,
                                          Int32 offset,
                                          Int32 length)
        {
            ...
            var addedLengthOverlap = oldChange.AddedLength > 0 ? offset + length - oldChange.Offset : 0;
        ...
        private Boolean _hasContentAddedOrRemoved;

        // True if the collection contains one or more entries that
        // result from a local property value changing on a TextElement.
        private Boolean _hasLocalPropertyValueChange;

        private SortedList<Int32, TextChange> _changes;
