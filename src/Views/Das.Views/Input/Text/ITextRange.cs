...
namespace Das.Views.Input.Text
{
    ...
    public interface ITextRange
    {
        ...
        /// <summary>
        /// </summary>
        void Select(ITextPointer position1,
        ...
        /// </summary>
        /// <returns></returns>
        IVisualElement GetUIElementSelected();
        ...
        /// <summary>
        /// </summary>
        void EndChange(Boolean disableScroll,
                       Boolean skipEvents);
        ...
        /// <summary>
        /// </summary>
        void NotifyChanged(Boolean disableScroll,
                           Boolean skipEvents);
        ...
        Boolean IgnoreTextUnitBoundaries { get; }
        ...
        Boolean HasConcreteTextContainer { get; }
        ...
        /// </summary>
        UInt32 _ContentGeneration { get; set; }

        /// <summary>
        ///     Defines a state of this text range
        /// </summary>
        Boolean _IsTableCellRange { get; set; }
        ...
        /// </summary>
        Int32 _ChangeBlockLevel { get; set; }
