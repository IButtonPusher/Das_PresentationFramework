...
{
    public class TextTreeTextNode : TextTreeNode
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        private void Merge()
        {
            ...
            if (nextNode != null)
            {
                ...
                else if ((previousNode._positionRefCount == 0 ||
                          previousNode._referencedEdge == ElementEdge.BeforeStart) &&
        ...
        public override TextTreeNode IncrementReferenceCount(ElementEdge edge,
                                                             Int32 delta)
        {
        ...
        // TextTreeTextNodes.
        public override void DecrementReferenceCount(ElementEdge edge)
        {
        ...
        // following node).
        public TextTreeTextNode Split(Int32 localOffset,
                                      ElementEdge edge)
        {
            ...
            if (localOffset == 0)
            {
                ...
                Invariant.Assert(
                    previousNode == null || previousNode.SymbolCount > 0 || previousNode.AfterEndReferenceCount,
        ...
        public override SplayTreeNode ContainedNode
        {
            ...
            set => Invariant.Assert(false, "Can't set child on a TextTreeTextNode!");
        }
        ...
        {
            get => _referencedEdge == ElementEdge.BeforeStart ? _positionRefCount > 0 : false;

            set => Invariant.Assert(false, "Can't set TextTreeTextNode ref counts directly!");
        }
        ...
        public override Boolean AfterStartReferenceCount
        {
            ...
            set => Invariant.Assert(false, "Text nodes don't have an AfterStart edge!");
        }
        ...
        public override Boolean BeforeEndReferenceCount
        {
            ...
            set => Invariant.Assert(false, "Text nodes don't have a BeforeEnd edge!");
        }

        // Count of TextPositions referencing the node's AfterEnd edge.
        public override Boolean AfterEndReferenceCount
        {
            get => _referencedEdge == ElementEdge.AfterEnd ? _positionRefCount > 0 : false;
        ...
        private Int32 _positionRefCount;
