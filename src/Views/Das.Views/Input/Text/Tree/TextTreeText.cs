...
{
    public static class TextTreeText
    {
        public static void ReadText(TextTreeRootTextBlock rootTextBlock,
                                    Int32 offset,
                                    Int32 count,
                                    Char[] chars,
                                    Int32 startIndex)
        ...
        public static void RemoveElementEdges(TextTreeRootTextBlock rootTextBlock, int offset, int symbolCount)
        {
        ...
        public static Char[] CutText(TextTreeRootTextBlock rootTextBlock,
                                     Int32 offset,
                                     Int32 count)
        {
            Char[] text;
        ...
        public static void RemoveText(TextTreeRootTextBlock rootTextBlock,
                                      Int32 offset,
                                      Int32 count)
        {
            Int32 firstBlockLocalOffset;
            TextTreeTextBlock firstBlock;
            Int32 lastBlockLocalOffset;
        ...
        public static void Remove(TextTreeTextBlock firstNode,
                                  TextTreeTextBlock lastNode)
        {
        ...
        public static void InsertElementEdges(TextTreeRootTextBlock rootTextBlock,
                                              Int32 offset,
                                              Int32 childSymbolCount)
        {
        ...
        // or an array of char.
        public static void InsertText(TextTreeRootTextBlock rootTextBlock,
                                      Int32 offset,
                                      Object text)
        {
            TextTreeTextBlock block;
        ...
        private static void InsertTextLeft(TextTreeTextBlock rightBlock,
                                           Object text,
                                           Int32 textOffset)
        {
            Int32 newBlockCount;
            ...
            if (textOffset < length)
            {
                ...
                if (textOffset < length)
                {
                    ...
                    if (textOffset < textEndOffset)
                    {
                        ...
                        newBlockCount += (textEndOffset - textOffset + TextTreeTextBlock.MaxBlockSize - 1) /
        ...
        private static void InsertTextRight(TextTreeTextBlock leftBlock,
                                            Object text,
                                            Int32 textOffset)
        {
            Int32 newBlockCount;
        ...
        private static TextTreeTextBlock FindBlock(TextTreeRootTextBlock rootTextBlock,
                                                   Int32 offset,
                                                   out Int32 localOffset)
        {
            ...
            {
                var previousBlock = (TextTreeTextBlock)node.GetPreviousNode();
