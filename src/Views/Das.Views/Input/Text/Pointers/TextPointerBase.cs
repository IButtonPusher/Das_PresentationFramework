...
namespace Das.Views.Input.Text.Pointers
{
    ...
    public static class TextPointerBase
    {
        //------------------------------------------------------
        //
        //  public Methods
        ...
        /// TextPointer to compare.
        /// </param>
        public static ITextPointer Min(ITextPointer position1, ITextPointer position2)
        {
        ...
        /// TextPointer to compare.
        /// </param>
        public static ITextPointer Max(ITextPointer position1, ITextPointer position2)
        {
            return position1.CompareTo(position2) >= 0 ? position1 : position2;
        }

        // Worker for GetText, accepts any ITextPointer.
        public static string GetTextInRun(ITextPointer position, LogicalDirection direction)
        {
            char[] text;
            int textLength;
            int getTextLength;
        ...
        public static int GetTextWithLimit(ITextPointer thisPointer, LogicalDirection direction, char[] textBuffer, int startIndex, int count, ITextPointer limit)
        {
            int charsCopied;
        ...
        public static bool IsAtFormatNormalizedPosition(ITextPointer position)
        {
        ...
        /// </value>
        public static bool IsAtInsertionPosition(ITextPointer position)
        {
        ...
        public static bool IsAtPotentialRunPosition(ITextPointer position)
        {
        ...
        // position.
        public static bool IsAtPotentialRunPosition(TextElement run)
        {
            return 
                run is Run && 
                run.IsEmpty && 
        ...
        public static bool IsAtPotentialParagraphPosition(ITextPointer position)
        {
        ...
        public static bool IsBeforeFirstTable(ITextPointer position)
        {
            TextPointerContext forwardContext = position.GetPointerContext(LogicalDirection.Forward);
            TextPointerContext backwardContext = position.GetPointerContext(LogicalDirection.Backward);
        ...
        public static bool IsInBlockUIContainer(ITextPointer position)
        {
            return (typeof(BlockUIContainer).IsAssignableFrom(position.ParentType));
        }

        public static bool IsAtBlockUIContainerStart(ITextPointer position)
        {
            return IsInBlockUIContainer(position) &&
                position.GetPointerContext(LogicalDirection.Backward) == TextPointerContext.ElementStart;
        }

        public static bool IsAtBlockUIContainerEnd(ITextPointer position)
        {
            return IsInBlockUIContainer(position) &&
        ...
        public static bool IsInAnchoredBlock(ITextPointer position)
        {
        ...
        public static bool IsInHyperlinkScope(ITextPointer position)
        {
        ...
        public static ITextPointer GetFollowingNonMergeableInlineContentStart(ITextPointer position)
        {
            ITextPointer navigator = position.CreatePointer();
            bool moved = false;
            Type elementType;
        ...
        public static bool IsAtNonMergeableInlineStart(ITextPointer position)
        {
        ...
        public static bool IsAtNonMergeableInlineEnd(ITextPointer position)
        {
        ...
        public static bool IsPositionAtNonMergeableInlineBoundary(ITextPointer position)
        {
            return IsAtNonMergeableInlineStart(position) || IsAtNonMergeableInlineEnd(position);
        }

        public static bool IsAtFormatNormalizedPosition(ITextPointer position, LogicalDirection direction)
        {
            return IsAtNormalizedPosition(position, direction, false /* respectCaretUnitBoundaries */);
        }

        public static bool IsAtInsertionPosition(ITextPointer position, LogicalDirection direction)
        {
            return IsAtNormalizedPosition(position, direction, true /* respectCaretUnitBoundaries */);
        }

        public static bool IsAtNormalizedPosition(ITextPointer position, LogicalDirection direction, bool respectCaretUnitBoundaries)
        {
        ...
        public static int GetOffset(ITextPointer thisPosition)
        {
        ...
        /// </param>
        /// <returns></returns>
        public static bool IsAtWordBoundary(ITextPointer thisPosition, LogicalDirection insideWordDirection)
        {
        ...
        /// </remarks>
        public static TextSegment GetWordRange(ITextPointer thisPosition)
        {
        ...
        /// The return value includes trailing whitespace, if any.
        /// </remarks>
        public static TextSegment GetWordRange(ITextPointer thisPosition, LogicalDirection direction)
        {
        ...
        // </summary>
        public static bool IsNextToPlainLineBreak(ITextPointer thisPosition, LogicalDirection direction)
        {
        ...
        public static Char[] NextLineCharacters = new char[] { '\n', '\r', '\v', '\f', '\u0085' /*NEL*/, '\u2028' /*LS*/, '\u2029' /*PS*/ };

        // Returns true if a specified char matches the Unicode definition of "newline".
        public static bool IsCharUnicodeNewLine(char ch)
        {
        ...
        /// </summary>
        public static bool IsNextToRichLineBreak(ITextPointer thisPosition, LogicalDirection direction)
        {
        ...
        /// ignoring any intermediate formatting elements.
        /// </summary>
        public static bool IsNextToParagraphBreak(ITextPointer thisPosition, LogicalDirection direction)
        {
        ...
        // </summary>
        public static bool IsNextToAnyBreak(ITextPointer thisPosition, LogicalDirection direction)
        {
            if (!thisPosition.IsAtInsertionPosition)
            {
                thisPosition = thisPosition.GetInsertionPosition(direction);
        ...
        /// </summary>
        public static bool IsAtLineWrappingPosition(ITextPointer position, ITextView textView)
        {
        ...
        public static bool IsAtRowEnd(ITextPointer thisPosition)
        {
        ...
        public static bool IsAfterLastParagraph(ITextPointer thisPosition)
        {
        ...
        public static bool IsAtParagraphOrBlockUIContainerStart(ITextPointer pointer)
        {
        ...
        public static ListItem GetListItem(TextPointer pointer)
        {
        ...
        public static ListItem GetImmediateListItem(TextPointer position)
        {
        ...
        public static bool IsInEmptyListItem(TextPointer position)
        {
        ...
        public static int MoveToLineBoundary(ITextPointer thisPointer, ITextView textView, int count)
        {
        ...
        public static int MoveToLineBoundary(ITextPointer thisPointer, ITextView textView, int count, bool respectNonMeargeableInlineStart)
        {
        ...
        public static Rectangle GetCharacterRect(ITextPointer thisPointer, LogicalDirection direction)
        {
            return GetCharacterRect(thisPointer, direction, /*transformToUiScope*/true);
        }

        // <see cref="TextPointer.GetCharacterRect"/>
        public static Rectangle GetCharacterRect(ITextPointer thisPointer, LogicalDirection direction, bool transformToUiScope)
        {
        ...
        public static bool MoveToFormatNormalizedPosition(ITextPointer thisNavigator, LogicalDirection direction)
        {
        ...
        /// </summary>
        public static bool MoveToInsertionPosition(ITextPointer thisNavigator, LogicalDirection direction)
        {
        ...
        /// </remarks>
        public static bool MoveToNextInsertionPosition(ITextPointer thisNavigator, LogicalDirection direction)
        {
        ...
        public static bool MoveToNextWordBoundary(ITextPointer thisNavigator, LogicalDirection movingDirection)
        {
            int moveCounter = 0;
        ...
        public static ITextPointer GetFrozenPointer(ITextPointer thisPointer, LogicalDirection logicalDirection)
        {
        ...
        public static bool ValidateLayout(ITextPointer thisPointer, ITextView textView)
        {
            if (textView == null)
            {
                return false;
        ...
        private static bool IsAtCaretUnitBoundary(ITextPointer position)
        {
            ...
            if (backwardContext == TextPointerContext.Text && forwardContext == TextPointerContext.Text)
            {
                ...
                {
                    // Check the insertion position with the public compound sequence
