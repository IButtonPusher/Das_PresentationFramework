...
namespace Das.Views.Input.Text.Pointers
{
    public class TextPointer : ContentPosition, ITextPointer
    {
        ...
        public TextPointer(TextPointer textPointer)
        {
            ...
            InitializeOffset(textPointer, 0, textPointer.GetGravitypublic());
        }

        // Creates a new TextPointer instance.
        public TextPointer(TextPointer position, int offset)
        {
            if (position == null)
            {
            ...
            InitializeOffset(position, offset, position.GetGravitypublic());
        }

        // Creates a new TextPointer instance.
        public TextPointer(TextPointer position, LogicalDirection direction)
        {
            InitializeOffset(position, 0, direction);
        }

        // Creates a new TextPointer instance.
        public TextPointer(TextPointer position, int offset, LogicalDirection direction)
        {
            InitializeOffset(position, offset, direction);
        }

        // Creates a new TextPointer instance.
        public TextPointer(TextContainer textContainer, int offset, LogicalDirection direction)
        {
            SplayTreeNode node;
            ElementEdge edge;
        ...
        // Creates a new TextPointer instance.
        public TextPointer(TextContainer tree, TextTreeNode node, ElementEdge edge)
        {
            Initialize(tree, node, edge, LogicalDirection.Forward, tree.PositionGeneration, false, false, tree.LayoutGeneration);
        }

        // Creates a new TextPointer instance.
        public TextPointer(TextContainer tree, TextTreeNode node, ElementEdge edge, LogicalDirection direction)
        {
        ...
        public TextPointer CreatePointer()
        {
            return new TextPointer(this);
        }

        // Constructor equivalent to ITextPointer.CreatePointer
        public TextPointer CreatePointer(LogicalDirection gravity)
        {
        ...
        /// is <see cref="Core.LogicalDirection.Backward"/>, or if it is positioned
        /// at the end of a text container  and the requested direction is
        /// <see cref="Core.LogicalDirection.Forward"/>.</para>
        ...
        public int GetTextRunLength(LogicalDirection direction)
        {
            ...
            if (_tree.PlainTextOnly)
            {
                ...
                {
                    count = _tree.publicSymbolCount - this.GetSymbolOffset() - 1;
                }
                else
                {
        ...
        /// <see cref="MediaTypeNames.Text"/> property for more sophisticated
        ...
        /// </remarks>
        public IBindableElement GetAdjacentElement(LogicalDirection direction)
        {
            ValidationHelper.VerifyDirection(direction, "direction");
        ...
        public void InsertTextInRun(string textData)
        {
            ...
            try
            {
                _tree.InsertTextpublic(insertPosition, textData);
            }
            finally
            {
                _tree.EndChange();
        ...
        public int DeleteTextInRun(int count)
        {
            ...
            try
            {
                if (count > 0)
                {
                    _tree.DeleteContentpublic(this, deleteToPosition);
                }
                else if (count < 0)
                {
                    _tree.DeleteContentpublic(deleteToPosition, this);
                }
            }
            finally
            {
        ...
        /// </exception>
        public void InsertTextElement(TextElement textElement)
        {
        ...
        /// </remarks>
        // public methods that depend on this property:
        ...
        /// </remarks>
        public Block ParagraphOrBlockUIContainer
        {
        ...
        public Inline GetNonMergeableInlineAncestor()
        {
        ...
        public ListItem GetListAncestor()
        {
        ...
        public static int GetTextInRun(TextContainer textContainer, int symbolOffset, TextTreeTextNode textNode, int nodeOffset, LogicalDirection direction, char[] textBuffer, int startIndex, int count)
        {
            int skipCount;
            int finalCount;
        ...
        public static IBindableElement GetAdjacentElement(TextTreeNode node, ElementEdge edge, LogicalDirection direction)
        {
        ...
        /// </exception>
        public void MoveToPosition(TextPointer textPosition)
        {
        ...
        /// </returns>
        public int MoveByOffset(int offset)
        {
            SplayTreeNode node;
            ElementEdge edge;
            int symbolOffset;
            ...
            if (offset != 0)
            {
                ...
                if (symbolOffset < 1)
                {
                    if (offset > 0)
                    {
                        ...
                        symbolOffset = _tree.publicSymbolCount - 1;
                ...
                else if (symbolOffset > _tree.publicSymbolCount - 1)
                {
                    ...
                    offset -= (symbolOffset - (_tree.publicSymbolCount - 1));
                    symbolOffset = _tree.publicSymbolCount - 1;
                }
        ...
        /// </remarks>
        public bool MoveToNextContextPosition(LogicalDirection direction)
        {
            TextTreeNode node;
            ElementEdge edge;
            bool moved;
        ...
        /// positioned where it started -- at the start of the following line.
        /// </remarks>
        public int MoveToLineBoundary(int count)
        {
            VerifyNotFrozen();
        ...
        /// according to flow schema.
        /// </exception>
        public void InsertUIElement(UIElement uiElement)
        {
            if (uiElement == null)
            {
            ...
            try
            {
                _tree.InsertEmbeddedObjectpublic(this, uiElement);
            }
            finally
            {
                _tree.EndChange();
        ...
        public TextElement GetAdjacentElementFromOuterPosition(LogicalDirection direction)
        {
        ...
        public void SetLogicalDirection(LogicalDirection direction)
        {
            ...
            if (GetGravitypublic() != direction)
            {
                ...
                Invariant.Assert(GetGravitypublic() == direction, "Inconsistent position gravity");
            }
        }
        ...
        /// </remarks>
        public TextPointer GetFrozenPointer(LogicalDirection logicalDirection)
        {
        ...
        int ITextPointer.CompareTo(StaticTextPointer position)
        {
            ...
            offsetPosition = TextContainer.GetpublicOffset(position);
        ...
        LocalValueEnumerator ITextPointer.GetLocalValueEnumerator()
        {
            ...
            if (element == null)
            {
                ...
                return (new IBindableElement()).GetLocalValueEnumerator();
            }
        ...
        /// <summary>
        /// </summary>
        public bool MoveToCaretPosition(LogicalDirection contentDirection)
        {
            TextPointer position;
        ...
        /// <summary>
        /// </summary>
        public bool MoveToNextCaretPosition(LogicalDirection direction)
        {
            TextPointer position;
            bool moved;
        ...
        /// <summary>
        /// </summary>
        public bool MoveToBackspaceCaretPosition()
        {
            TextPointer position;
            bool moved;
        ...
        // Returns the TextTreeTextNode in the direction indicated bordering
        // a TextPointer, or null if no such node exists.
        public static TextTreeTextNode GetAdjacentTextNodeSibling(TextTreeNode node, ElementEdge edge, LogicalDirection direction)
        {
        ...
        // Returns the TextTreeTextNode in the direction indicated bordering
        // a TextPointer, or null if no such node exists.
        public TextTreeTextElementNode GetAdjacentTextElementNode(LogicalDirection direction)
        {
        ...
        public static TextTreeNode GetAdjacentSiblingNode(TextTreeNode node, ElementEdge edge, LogicalDirection direction)
        {
        ...
        // Returns the symbol offset within the TextContainer of this Position.
        public static int GetSymbolOffset(TextContainer tree, TextTreeNode node, ElementEdge edge)
        {
            int offset;
        ...
        public static TextTreeNode GetScopingNode(TextTreeNode node, ElementEdge edge)
        {
        ...
        public bool GetNextNodeAndEdge(out TextTreeNode node, out ElementEdge edge)
        {
            DebugAssertGeneration();
        ...
        public static bool GetNextNodeAndEdge(TextTreeNode sourceNode, ElementEdge sourceEdge, bool plainTextOnly, out TextTreeNode node, out ElementEdge edge)
        {
        ...
        public bool GetPreviousNodeAndEdge(out TextTreeNode node, out ElementEdge edge)
        {
            DebugAssertGeneration();
        ...
        public static bool GetPreviousNodeAndEdge(TextTreeNode sourceNode, ElementEdge sourceEdge, bool plainTextOnly, out TextTreeNode node, out ElementEdge edge)
        {
            SplayTreeNode currentNode;
            SplayTreeNode newNode;
            SplayTreeNode containingNode;
        ...
        public static TextPointerContext GetPointerContextForward(TextTreeNode node, ElementEdge edge)
        {
        ...
        public static TextPointerContext GetPointerContextBackward(TextTreeNode node, ElementEdge edge)
        {
            TextPointerContext symbolType;
        ...
        // Helper that returns a IBindableElement which is a common ancestor of two pointers.
        public static IBindableElement GetCommonAncestor(TextPointer position1, TextPointer position2)
        {
            TextElement element1 = position1.Parent as TextElement;
            TextElement element2 = position2.Parent as TextElement;

            IBindableElement commonAncestor;
        ...
        Type ITextPointer.ParentType
        {
            get
            {
                ...
                IBindableElement element = this.Parent;
        ...
        public bool HasNonMergeableInlineAncestor
        {
            get
            {
                Inline ancestor = this.GetNonMergeableInlineAncestor();
        ...
        public bool IsAtNonMergeableInlineStart
        {
            get
            {
        ...
        public Block ParentBlock
        {
            get
            {
                ...
                IBindableElement parentBlock = this.Parent;
        ...
        private void InitializeOffset(TextPointer position, int distance, LogicalDirection direction)
        {
            ...
            if (distance != 0)
            {
                ...
                if (offset < 1 || offset > position.TextContainer.publicSymbolCount - 1)
                {
                    throw new ArgumentException(SR.Get(SRID.BadDistance));
                }
        ...
        // Returns the IBindableElement scoping this position.
        private IBindableElement GetDependencyParent()
        {
            DebugAssertGeneration();
        ...
        public static TextTreeNode GetAdjacentNode(TextTreeNode node, ElementEdge edge, LogicalDirection direction)
        {
            TextTreeNode adjacentNode;
        ...
        {
            RepositionForGravity(ref node, ref edge, GetGravitypublic());
