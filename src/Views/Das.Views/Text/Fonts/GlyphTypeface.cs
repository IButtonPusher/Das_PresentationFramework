...
namespace Das.Views.Text.Fonts
{
    ...
    public class GlyphTypeface : ITypefaceMetrics, ISupportInitialize
    {
        ...
        {        
            ...
            FontFace fontFaceDWrite = _font.GetFontFace();
            try
            {
                using (FontFile fontFile = fontFaceDWrite.GetFileZero())
                {
        ...
        private void Initialize(Uri typefaceSource, StyleSimulations styleSimulations)
        {
            ...
            FontCollection fontCollection = DWriteFactory.GetFontCollectionFromFile(fontSourceUri);
            using (FontFace fontFaceDWrite = DWriteFactory.Instance.CreateFontFace(fontSourceUri,
                                                                                                                  (uint)faceIndex,
                                                                                                                  (FontSimulations)styleSimulations))
            {
