...
{
    public static class TextSchema
    {
        // ...............................................................
        //
        // Constructors
        ...
        static TextSchema()
        {
            ...
            var textElementPropertyList = new IDependencyProperty[]
                {
                    ...
                    TextBase.FontWeightProperty,
                    TextElement.FontStretchProperty,
                    TextBase.FontSizeProperty,
                    VisualElement.ForegroundProperty,
                };
        ...
        public static bool IsInTextContent(ITextPointer position)
        {
            return IsValidChild(position, typeof(string));
        }

#if UNUSED
        public static bool IsValidChild(TextElement parent, TextElement child)
        {
            return ValidateChild(parent, child, false /* throwIfIllegalChild */, false /* throwIfIllegalHyperlinkDescendent */);
        }
#endif

        public static bool ValidateChild(TextElement parent, TextElement child, bool throwIfIllegalChild, bool throwIfIllegalHyperlinkDescendent)
        {
        ...
        public static bool IsValidChild(TextElement parent, Type childType)
        {
            return ValidateChild(parent, childType, false /* throwIfIllegalChild */, false /* throwIfIllegalHyperlinkDescendent */);
        }

        public static bool ValidateChild(TextElement parent, Type childType, bool throwIfIllegalChild, bool throwIfIllegalHyperlinkDescendent)
        {
            // Disallow nested hyperlink elements.
            if (TextSchema.HasHyperlinkAncestor(parent))
            {
        ...
        public static bool IsValidChild(TextPointer position, Type childType)
        {
            return ValidateChild(position, childType, false /* throwIfIllegalChild */, false /* throwIfIllegalHyperlinkDescendent */);
        }

        public static bool ValidateChild(TextPointer position, Type childType, bool throwIfIllegalChild, bool throwIfIllegalHyperlinkDescendent)
        {
        ...
        public static bool IsValidSibling(Type siblingType, Type newType)
        {
        ...
        public static bool IsValidChild(ITextPointer position, Type childType)
        {
            // Disallow nested hyperlink elements.
        ...
        public static bool IsValidChildOfContainer(Type parentType, Type childType)
        {
        ...
        public static bool HasHyperlinkAncestor(TextElement element)
        {
        ...
        /// <returns></returns>
        public static bool IsFormattingType(Type elementType)
        {
            return 
        ...
        /// </summary>
        public static bool IsKnownType(Type elementType)
        {
        ...
        public static bool IsNonFormattingInline(Type elementType)
        {
            return typeof(Inline).IsAssignableFrom(elementType) && !IsFormattingType(elementType);
        }

        public static bool IsMergeableInline(Type elementType)
        {
            return IsFormattingType(elementType) && !IsNonMergeableInline(elementType);
        }

        public static bool IsNonMergeableInline(Type elementType)
        {
        ...
        /// </summary>
        public static bool AllowsParagraphMerging(Type elementType)
        {
            return
        ...
        /// </returns>
        public static bool IsParagraphOrBlockUIContainer(Type elementType)
        {
            return
                typeof(Paragraph).IsAssignableFrom(elementType) ||
        ...
        public static bool IsBlock(Type type)
        {
            return ( //
                typeof(Block).IsAssignableFrom(type));
        }

        public static bool IsBreak(Type type)
        {
            return ( //
        ...
        public static bool HasTextDecorations(object value)
        {
        ...
        public static Type GetStandardElementType(Type type, bool reduceElement)
        {
        ...
        public static DependencyProperty[] GetInheritableProperties(Type type)
        {
        ...
        public static DependencyProperty[] GetNoninheritableProperties(Type type)
        {
            // Run-derived elements
            // --------------------
            if (typeof(Run).IsAssignableFrom(type))
        ...
        /// </summary>
        public static bool IsParagraphProperty(DependencyProperty formattingProperty)
        {
        ...
        /// </summary>
        public static bool IsCharacterProperty(DependencyProperty formattingProperty)
        {
        ...
        /// </summary>
        public static bool IsNonFormattingCharacterProperty(DependencyProperty property)
        {
        ...
        public static DependencyProperty[] GetNonFormattingCharacterProperties()
        {
        ...
        /// </remarks>
        public static bool IsStructuralCharacterProperty(DependencyProperty formattingProperty)
        {
            int i;
        ...
        public static bool IsPropertyIncremental(DependencyProperty property)
        {
            if (property == null)
            {
                return false;
        ...
        public static DependencyProperty[] BehavioralProperties
        {
            get
            {
        ...
        public static DependencyProperty[] ImageProperties
        {
            get
            {
        ...
        public static DependencyProperty[] StructuralCharacterProperties
        {
            get
            {
