...
namespace Das.ViewModels.Collections
{
    public class DoubleConcurrentDictionary<TKey1, TKey2, TValue>
    {
        ...
        public void AddRange<TKeyValue>(TKey1 k1,
                                        IEnumerable<TKeyValue> keyVals)
        ...
        public IEnumerable<TValue> GetValues(TKey1 k1,
                                             Func<TKey2, Boolean> predicate)
        {
            if (!_backingDictionary.TryGetValue(k1, out var d2))
                yield break;
        ...
        {
            return new ConcurrentDictionary<TKey2, TValue>();
        }

        public TValue this[TKey1 k1,
                           TKey2 k2]
        {
