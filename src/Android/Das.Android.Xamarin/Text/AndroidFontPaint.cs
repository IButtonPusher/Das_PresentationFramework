                                ...
                                IFontRenderer
{
   ...
   private StaticLayout GetOrCreateStaticLayout(String text) => GetOrCreateStaticLayout(text, MeasureText);
   ...
   private Canvas GetCanvas() => Canvas ?? throw new NullReferenceException();
