...
public readonly struct QuantifiedThickness : IBoxValue<QuantifiedDouble>
{
                              ...
                              QuantifiedDouble bottom)
   {
      ...
      _isAllPx = left.IsUnitsEffectivelyPixels && top.IsUnitsEffectivelyPixels &&
                 right.IsUnitsEffectivelyPixels && bottom.IsUnitsEffectivelyPixels;
   }
   ...
   private readonly Boolean _isAllPx;
