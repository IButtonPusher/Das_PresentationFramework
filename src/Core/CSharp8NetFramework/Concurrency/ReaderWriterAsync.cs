    ...
    public partial class ReaderWriterAsync : IReaderWriterAsync
    {
            ...
            TParam param, Func<TParam, Task<TResult>> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncTaskAwaiter<TParam, TResult>(param,
        ...
        public Task<TResult> ReadAsync<TParam1, TParam2, TParam3, TParam4, TResult>(
            TParam1 p1, 
            TParam2 p2, 
            TParam3 p3, 
            TParam4 p4,
            Func<TParam1, TParam2, TParam3, TParam4, TResult> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncWaiter<TParam1, TParam2, TParam3, TParam4, TResult>(
                        p1, p2, p3, p4, action, WorkerTypes.Reader);
                    _waiters.Enqueue(waiter);
                    return waiter;
                }
                                                                   ...
                                                                   Func<TParam1, TParam2, TResult> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncWaiter<TParam1, TParam2, TResult>(p1, p2,
                        action, WorkerTypes.Writer);
                    _waiters.Enqueue(waiter);
                    return waiter;
                }
                                                          ...
                                                          Action<TParam1, TParam2, TParam3> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncActionWaiter<TParam1, TParam2, TParam3>(p1, p2, p3,
                        action, WorkerTypes.Writer);
                    _waiters.Enqueue(waiter);
                    return waiter;
                }
        ...
        public Task WriteTaskAsync<TParam1, TParam2, TParam3, TParam4>(
            TParam1 p1, 
                                                                       TParam2 p2, 
                                                                       ...
                                                                       Func<TParam1, TParam2, TParam3, TParam4, Task> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncWaiter<TParam1, TParam2, TParam3, TParam4, Task>(p1, p2, p3, p4,
                        action, WorkerTypes.Writer);
                    _waiters.Enqueue(waiter);
                    return waiter;
                }
            ...
            try
            {
                return TaskEx.FromResult(action(p1, p2, p3, p4));
            }
            finally
            {
                EndWriterImpl();
        ...
        public Task<TResult> WriteAsync<TParam1, TParam2, TParam3, TParam4, TResult>(TParam1 p1, 
                                                                                     TParam2 p2, 
                                                                                     TParam3 p3, 
                                                                                     TParam4 p4,
                                                                                     Func<TParam1, TParam2, TParam3, TParam4, TResult> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncWaiter<TParam1, TParam2, TParam3, TParam4, TResult>(p1, p2, p3, p4,
                        action, WorkerTypes.Writer);
                    _waiters.Enqueue(waiter);
                    return waiter;
                }
        ...
        public Task<TResult> WriteAsync<TParam1, TParam2, TParam3, TResult>(TParam1 p1, 
            TParam2 p2, 
            TParam3 p3,
            Func<TParam1, TParam2, TParam3, TResult> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncWaiter<TParam1, TParam2, TParam3, TResult>(p1, p2, p3, 
                        action, WorkerTypes.Writer);
                    _waiters.Enqueue(waiter);
                    return waiter;
                }
            ...
            try
            {
                return TaskEx.FromResult(action(p1, p2, p3));
            }
            finally
            {
                EndWriterImpl();
                                                 ...
                                                 Func<TParam1, TParam2, Task> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncAwaiter<TParam1,TParam2>(p1, p2,
                        action, WorkerTypes.Writer);
                    _waiters.Enqueue(waiter);
                    return waiter;
                }
        ...
        public Task<TResult> WriteTaskAsync<TParam1, TParam2, TResult>(
            TParam1 p1,
            TParam2 p2,
            Func<TParam1, TParam2, Task<TResult>> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncAwaiter<TParam1,TParam2,TResult>(p1, p2,
                        action, WorkerTypes.Writer);
                    _waiters.Enqueue(waiter);
                    return waiter;
                }
                                              ...
                                              Func<TParam, Task<Int32>> action)
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    _waiterCount++;
                    var waiter = new AsyncTaskAwaiter<TParam, Int32>(param,
                        action, WorkerTypes.Writer);
                    _waiters.Enqueue(waiter);
                    return waiter;
                }
