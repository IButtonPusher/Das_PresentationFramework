...
{
    public class FuncWaiter<TParam1, TParam2, TParam3, TParam4, TResult> : FuncWaiterBase<TResult>
    {
        ...
        public static implicit operator Task<TResult>(FuncWaiter<TParam1, TParam2, TParam3, TParam4, TResult> worker)
        {
            return worker.Task;
        }
