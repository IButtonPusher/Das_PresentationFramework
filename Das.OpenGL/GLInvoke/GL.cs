...
namespace Das.OpenGL
{
    ...
    public static partial class GL
    {
        ...
        public static UInt32 CreateVertexShader() => CreateShader(GL_VERTEX_SHADER);
        ...
        public static void GetShaderInfoLog (UInt32 shader, Int32 bufSize, IntPtr length, 
        ...
        public static void GetShaderiv (UInt32 shader, UInt32 pname, Int32[] parameters)
        {
        ...
        {
            IntPtr p = Marshal.AllocHGlobal(data.Length * sizeof(Single));
        ...
        private delegate void glGenVertexArrays(Int32 n, UInt32[] arrays);
        ...
        private delegate void glDeleteVertexArrays(Int32 n, UInt32[] arrays);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)] public static extern void glDrawElements(UInt32 mode, Int32 count, UInt32 type, IntPtr indices);
        [DllImport(LIBRARY_OPENGL, SetLastError = true)] public static extern void glDrawArrays (UInt32 mode, Int32 first, Int32 count);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glClearColor(Single red, Single green, Single blue,
            Single alpha);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glVertex3f(Single x, Single y, Single z);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glVertex2d(Double x, Double y);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glVertex2f(Single x, Single y);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glRectd(Double x1, Double y1, Double x2, Double y2);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glRectf(Single x1, Single y1, Single x2, Single y2);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glColor3f(Single red, Single green, Single blue);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glReadPixels(Int32 x, Int32 y, Int32 width, Int32 height,
            UInt32 format, UInt32 type, IntPtr pixels);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glTranslatef(Single x, Single y, Single z);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glTranslated(Double x, Double y, Double z);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glRotatef(Single angle, Single x, Single y, Single z);

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glPushMatrix();

        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glGetIntegerv(UInt32 pname, Int32[] params_notkeyword);
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glCallLists(Int32 n, UInt32 type, Byte[] lists);
        ...
        [DllImport(LIBRARY_OPENGL, SetLastError = true)]
        public static extern void glGetFloatv(UInt32 pname, Single[] params_notkeyword);
