...
namespace AsyncResults.ForEach
{
    ...
    public static class IAsyncEnumerableExtensions
    {
        ...
        /// <param name="source">An <see cref="IAsyncEnumerable" /> to return the single element of.</param>
        ...
        /// <param name="manyExceptionMessage">
        ///     The message of an exception which is thrown when the source collection has more than
        ///     one element.
        /// </param>
        /// <param name="token">A <see cref="CancellationToken" /> that can halt enumeration of <paramref name="source" />.</param>
        public static Task<TSource> SingleAsync<TSource>(
        ...
        /// <param name="source">An <see cref="IAsyncEnumerable{T}" /> to return the single element of.</param>
        /// <param name="predicate">Criteria predicate to select the only element.</param>
        /// <param name="noneExceptionMessage">
        ///     The message of an exception which is thrown when the source collection is has no
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                while (await enumerator.MoveNextAsync().ConfigureAwait(false))
                {
                    ...
                    {
                        if (matchFound)
                            throw new InvalidOperationException(String.IsNullOrEmpty(manyExceptionMessage)
                                ? "Several elements found matching the criteria."
                                : manyExceptionMessage);
            ...
            if (!matchFound)
                throw new InvalidOperationException(String.IsNullOrEmpty(noneExceptionMessage)
                    ? "No element found matching the criteria."
                    : noneExceptionMessage);

            return lastMatch;
        }

        /// <summary>
        ///     Returns the only element of a sequence, and returns a default value if there is not exactly one element in the
        ///     sequence.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <param name="source">An <see cref="IAsyncEnumerable{T}" /> to return the single element of.</param>
        ...
        /// <summary>
        ///     Returns the only element of a sequence, and returns a default value if there is not exactly one element in the
        ///     sequence that matches the criteria.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <param name="source">An <see cref="IAsyncEnumerable{T}" /> to return the single element of.</param>
        /// <param name="predicate">Criteria predicate to select the only element.</param>
        ...
        {
            private static Boolean _true(T item) => true;

            public static readonly Func<T, Boolean> True = _true;
        }
        ...
        ///     An optional custom exception message for the case when the <paramref name="source" /> is
        ///     empty
        /// </param>
        /// <param name="token">A <see cref="CancellationToken" /> that can halt enumeration of <paramref name="source" /></param>
        public static Task<TSource> FirstAsync<TSource>(
            ...
            CancellationToken token = default)
        {
            ...
            throw new InvalidOperationException(String.IsNullOrEmpty(exceptionMessage)
        ...
        /// <summary>
        ///     Returns the first element in a sequence that satisfies a specified condition, or a default value if no element is
        ///     found.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" /></typeparam>
        /// <param name="source">An <see cref="IAsyncEnumerable{T}" /> to return an element from.</param>
        ...
        private struct SelectContext<TSource, TResult>
        {
            ...
            private static async Task _enumerate(AsyncEnumerator<TResult>.Yield yield,
                                                 SelectContext<TSource, TResult> context)
            {
            ...
            public static readonly Func<AsyncEnumerator<TResult>.Yield, SelectContext<TSource, TResult>, Task>
        ...
        public static IAsyncEnumerable<TResult> Select<TSource, TResult>(
            this IAsyncEnumerable<TSource> source,
            Func<TSource, Int64, TResult> selector)
        {
            if (null == source)
                throw new ArgumentNullException(nameof(source));
            if (null == selector)
        ...
        {
            public IAsyncEnumerable<TSource> Source;
            public Func<TSource, Int64, TResult> Selector;

            private static async Task _enumerate(AsyncEnumerator<TResult>.Yield yield,
                                                 SelectWithIndexContext<TSource, TResult> context)
            {
                var enumerator = context.Source.GetAsyncEnumerator(yield.CancellationToken);
                try
                {
            ...
            public static readonly Func<AsyncEnumerator<TResult>.Yield, SelectWithIndexContext<TSource, TResult>, Task>
                Enumerate = _enumerate;
        }
        ...
        /// <summary>
        ///     Projects each element of a sequence to an IAsyncEnumerable&lt;T&gt; and flattens the resulting sequences into one
        ///     sequence.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        ...
        private struct SelectManyContext<TSource, TItem, TResult>
        {
            ...
            private static async Task _enumerate(AsyncEnumerator<TResult>.Yield yield,
                                                 SelectManyContext<TSource, TItem, TResult> context)
            {
                ...
                try
                {
                    while (await sourceEnumerator.MoveNextAsync().ConfigureAwait(false))
                    {
                        ...
                        try
                        {
                            ...
                            {
                                var resultItem =
                                    context.ResultSelector(sourceEnumerator.Current, itemsEnumerator.Current);
            ...
            public static readonly
                Func<AsyncEnumerator<TResult>.Yield, SelectManyContext<TSource, TItem, TResult>, Task> Enumerate =
                    _enumerate;
        }
        ...
        private struct SelectManySyncContext<TSource, TItem, TResult>
        {
            ...
            private static async Task _enumerate(AsyncEnumerator<TResult>.Yield yield,
                                                 SelectManySyncContext<TSource, TItem, TResult> context)
            {
                var sourceEnumerator = context.Source.GetAsyncEnumerator(yield.CancellationToken);
                try
                {
            ...
            public static readonly
                Func<AsyncEnumerator<TResult>.Yield, SelectManySyncContext<TSource, TItem, TResult>, Task> Enumerate =
                    _enumerate;
        }
        ...
        private struct TakeContext<TSource>
        {
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, TakeContext<TSource>, Task> Enumerate =
                _enumerate;
        }
        ...
        {
            public IAsyncEnumerable<TSource> Source;
            public Func<TSource, Boolean> Predicate;

            private static async Task _enumerate(AsyncEnumerator<TSource>.Yield yield,
                                                 TakeWhileContext<TSource> context)
            {
                var enumerator = context.Source.GetAsyncEnumerator(yield.CancellationToken);
                try
                {
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, TakeWhileContext<TSource>, Task> Enumerate =
                _enumerate;
        }
        ...
        /// <summary>
        ///     Creates a <see cref="Dictionary{TKey, TValue}" /> from an <see cref="IAsyncEnumerable{T}" /> according to a
        ...
        /// <param name="source">An <see cref="IAsyncEnumerable{T}" /> to create a <see cref="Dictionary{TKey, TValue}" /> from.</param>
        /// <param name="keySelector">A function to extract a key from each element.</param>
        /// <param name="elementSelector">A transform function to produce a plan element value from each element.</param>
        /// <param name="cancellationToken">A cancellation token to cancel the async operation.</param>
        /// <returns></returns>
        ...
        private class Lookup<TKey, TElement> : ILookup<TKey, TElement>
        {
            ...
            public Boolean Contains(TKey key) => _dictionary.ContainsKey(key);
        ...
        /// <summary>
        ///     Creates a <see cref="ILookup{TKey, TElement}" /> from an <see cref="IAsyncEnumerable{T}" /> according to a
        ...
        /// <summary>
        ///     Creates a <see cref="ILookup{TKey, TElement}" /> from an <see cref="IAsyncEnumerable{T}" /> according to a
        ///     specified key selector function and an element selector function.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector" />.</typeparam>
        /// <typeparam name="TElement">The type of the value returned by <paramref name="elementSelector" />.</typeparam>
        ...
        private struct SkipContext<TSource>
        {
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, SkipContext<TSource>, Task> Enumerate =
                _enumerate;
        }
        ...
        private struct SkipWhileContext<TSource>
        {
            ...
            private static async Task _enumerate(AsyncEnumerator<TSource>.Yield yield,
                                                 SkipWhileContext<TSource> context)
            {
                var enumerator = context.Source.GetAsyncEnumerator(yield.CancellationToken);
                try
                {
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, SkipWhileContext<TSource>, Task> Enumerate =
                _enumerate;
        }
        ...
        private struct WhereContext<TSource>
        {
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, WhereContext<TSource>, Task> Enumerate =
                _enumerate;
        }
        ...
        public static IAsyncEnumerable<TSource> Where<TSource>(
            this IAsyncEnumerable<TSource> source,
            Func<TSource, Int64, Boolean> predicate)
        {
            if (null == source)
                throw new ArgumentNullException(nameof(source));
            if (null == predicate)
        ...
        {
            public IAsyncEnumerable<TSource> Source;
            public Func<TSource, Int64, Boolean> Predicate;

            private static async Task _enumerate(AsyncEnumerator<TSource>.Yield yield,
                                                 WhereWithIndexContext<TSource> context)
            {
                var enumerator = context.Source.GetAsyncEnumerator(yield.CancellationToken);
                try
                {
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, WhereWithIndexContext<TSource>, Task>
                Enumerate = _enumerate;
        }
        ...
        /// <param name="source">
        ///     An <see cref="IAsyncEnumerable" /> that contains the elements to be cast to type
        ...
        private struct CastContext<TResult>
        {
            ...
            public static readonly Func<AsyncEnumerator<TResult>.Yield, CastContext<TResult>, Task> Enumerate =
                _enumerate;
        }
        ...
        private struct OfTypeContext<TResult>
        {
            ...
            public static readonly Func<AsyncEnumerator<TResult>.Yield, OfTypeContext<TResult>, Task> Enumerate =
                _enumerate;
        }
        ...
        //public static ExceptionDispatchInfo Capture(this Exception source)
        //{
        //    if (source == null)
        //    {
        //        throw new ArgumentNullException(nameof(source));
        ...
        private struct DefaultIfEmptyContext<TSource>
        {
            ...
            private static async Task _enumerate(AsyncEnumerator<TSource>.Yield yield,
                                                 DefaultIfEmptyContext<TSource> context)
            {
                var enumerator = context.Source.GetAsyncEnumerator(yield.CancellationToken);
                try
                {
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, DefaultIfEmptyContext<TSource>, Task>
                Enumerate = _enumerate;
        }
        ...
        public static IAsyncEnumerable<TStandardCollection> Batch<TSource, TStandardCollection>(
            this IAsyncEnumerable<TSource> source,
            Int32 batchSize)
            => Batch(source, batchSize, Int64.MaxValue, null,
        ...
        ///     A function that computes a weight of a particular element, which is used to make a
        ///     decision if it can fit into a batch.
        /// </param>
        public static IAsyncEnumerable<List<TSource>> Batch<TSource>(
            this IAsyncEnumerable<TSource> source,
            Int64 maxBatchWeight,
            Func<TSource, Int64> weightSelector)
            ...
            Action<TBatch, TSource> addItem)
        {
            ...
            if (createBatch == null)
                throw new ArgumentNullException(nameof(createBatch),
                    "You must specify a function that creates a batch.");
            if (addItem == null)
                throw new ArgumentNullException(nameof(addItem),
                    "You must specify an action that adds an item to a batch.");
            ...
            return new AsyncEnumerableWithState<TBatch, BatchContext<TSource, TBatch>>(
                ...
                new BatchContext<TSource, TBatch>
                {
                    ...
                    MaxItemsInBatch = maxItemsInBatch ?? Int32.MaxValue,
        ...
        internal static class BatchCollectionHelper<TSource>
        {
            ...
            public static Func<Int32?, TCollection> GetCreateCollectionFunction<TCollection>()
            {
                if (typeof(TCollection) == typeof(List<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createList;

                if (typeof(TCollection) == typeof(Stack<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createStack;

                if (typeof(TCollection) == typeof(Queue<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createQueue;

                if (typeof(TCollection) == typeof(HashSet<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createHashSet;

                if (typeof(TCollection) == typeof(LinkedList<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createLinkedList;

                if (typeof(TCollection) == typeof(SortedSet<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createSortedSet;

                if (typeof(TCollection) == typeof(BlockingCollection<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createBlockingCollection;

                if (typeof(TCollection) == typeof(ConcurrentStack<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createConcurrentStack;

                if (typeof(TCollection) == typeof(ConcurrentQueue<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createConcurrentQueue;

                if (typeof(TCollection) == typeof(ConcurrentBag<TSource>))
                    return (Func<Int32?, TCollection>) (Object) _createConcurrentBag;
            ...
            private static readonly Func<Int32?, Stack<TSource>> _createStack = CreateStack;
            private static readonly Action<Stack<TSource>, TSource> _addToStack = AddToStack;
            private static readonly Func<Int32?, Queue<TSource>> _createQueue = CreateQueue;
            private static readonly Action<Queue<TSource>, TSource> _addToQueue = AddToQueue;
            private static readonly Func<Int32?, HashSet<TSource>> _createHashSet = CreateHashSet;
            private static readonly Action<HashSet<TSource>, TSource> _addToHashSet = AddToHashSet;
            private static readonly Func<Int32?, LinkedList<TSource>> _createLinkedList = CreateLinkedList;
            private static readonly Action<LinkedList<TSource>, TSource> _addToLinkedList = AddToLinkedList;
            private static readonly Func<Int32?, SortedSet<TSource>> _createSortedSet = CreateSortedSet;
            private static readonly Action<SortedSet<TSource>, TSource> _addToSortedSet = AddToSortedSet;

            private static readonly Func<Int32?, BlockingCollection<TSource>> _createBlockingCollection =
                CreateBlockingCollection;

            private static readonly Action<BlockingCollection<TSource>, TSource> _addToBlockingCollection =
                AddToBlockingCollection;

            private static readonly Func<Int32?, ConcurrentStack<TSource>> _createConcurrentStack =
                CreateConcurrentStack;

            private static readonly Action<ConcurrentStack<TSource>, TSource> _addToConcurrentStack =
                AddToConcurrentStack;

            private static readonly Func<Int32?, ConcurrentQueue<TSource>> _createConcurrentQueue =
                CreateConcurrentQueue;

            private static readonly Action<ConcurrentQueue<TSource>, TSource> _addToConcurrentQueue =
                AddToConcurrentQueue;

            private static readonly Func<Int32?, ConcurrentBag<TSource>> _createConcurrentBag = CreateConcurrentBag;
        ...
        {
            public IAsyncEnumerable<TSource> Source;
            public Int32? BatchPreallocateSize;
            public Int32 MaxItemsInBatch;
            public Int64 MaxBatchWeight;
            public Func<TSource, Int64> WeightSelector;
            public Func<Int32?, TBatch> CreateBatch;
            public Action<TBatch, TSource> AddItemToBatch;

            private static async Task _enumerate(AsyncEnumerator<TBatch>.Yield yield,
                                                 BatchContext<TSource, TBatch> context)
            {
            ...
            public static readonly Func<AsyncEnumerator<TBatch>.Yield, BatchContext<TSource, TBatch>, Task> Enumerate =
                _enumerate;
        }
        ...
        private struct ExtraElementContext<TSource>
        {
            ...
            private static async Task _enumerate(AsyncEnumerator<TSource>.Yield yield,
                                                 ExtraElementContext<TSource> context)
            {
                if (context.Prepend)
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, ExtraElementContext<TSource>, Task> Enumerate =
                _enumerate;
        }
        ...
        private struct ConcatContext<TSource>
        {
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, ConcatContext<TSource>, Task> Enumerate =
                _enumerate;
        }
        ...
        /// <summary>
        ///     Returns distinct elements from a sequence by using a specified <see cref="IEqualityComparer{T}" /> to compare
        ///     values.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <param name="source">The sequence to remove duplicate elements from.</param>
        ...
        private struct DistinctContext<TSource>
        {
            ...
            public static readonly Func<AsyncEnumerator<TSource>.Yield, DistinctContext<TSource>, Task> Enumerate =
                _enumerate;
        }
        ...
        /// <summary>
        ///     Applies an accumulator function over a sequence. The specified seed value is used as the initial accumulator value,
        ///     and the specified function is used to select the plan value.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <typeparam name="TAccumulate">The type of the accumulator value.</typeparam>
        ...
        /// <param name="seed">The initial accumulator value.</param>
        /// <param name="func">An accumulator function to be invoked on each element.</param>
        /// <param name="resultSelector">A function to transform the final accumulator value into the plan value.</param>
        /// <param name="cancellationToken">A cancellation token to cancel the async operation.</param>
        ...
        public static async Task<Boolean> AllAsync<TSource>(
            this IAsyncEnumerable<TSource> source,
            Func<TSource, Boolean> predicate,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source" /> or <paramref name="predicate" /> is null.</exception>
        public static async Task<Boolean> AnyAsync<TSource>(
            this IAsyncEnumerable<TSource> source,
            Func<TSource, Boolean> predicate,
            CancellationToken cancellationToken = default)
        {
